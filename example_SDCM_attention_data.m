...
DCM.Y.X0   = xY.X0; % DCM.Y.X0   = [ones(size(xY.X0,1),1),xY.X0(:,2:6)];  % low freqency fluctuations % SDCM
...
pE.A        = zeros(n);  % endogenous % SDCM
pE.B        = zeros(n,n,2); % modulatory % SDCM

...
%subplot(1,2,1) % changed by Yuexin 20251105
n      = length(name);
p1 = barh(1:n,F);
set(p1,'FaceColor',"#1E3765");
hold on
xlim([max(max(F)-40, 0), inf]);
plot([1 1]*(max(F) - 3),[0 n],'LineWidth',4,'Color',"#DC4633"), hold off
%set(gca,'YTick',1:n)
set(gca,'YTickLabel','')
